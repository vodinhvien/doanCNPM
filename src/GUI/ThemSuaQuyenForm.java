...
public class ThemSuaQuyenForm extends JFrame {
    ...
    public ThemSuaQuyenForm(String _type, String _maq) {
        ...
        if (this.type.equals("Thêm")) {
            ...
            for (Role q : qlqBUS.getList()) {
                if (Integer.toString(q.getRoleID()).equals(_maq)) {
                    this.qSua = q;
                }
            }
            if (this.qSua == null) {
            ...
            txMaQuyen.setText(Integer.toString(this.qSua.getRoleID()));
            txTenQuyen.setText(this.qSua.getRoleName());
            chitietForm.setQuyen(this.qSua.getChitiet());
...
class ChiTietQuyenForm extends JPanel {
    ...
    final String[] type = {"Xem và Quản lý"};
    ...
    public ChiTietQuyenForm() {
        ...
        dsPanel.add(new PanelChooseQuyen("Bán Hàng", new String[]{"Bán hàng"}, new String[]{"banHang"}));
        dsPanel.add(new PanelChooseQuyen("Nhập Hàng", new String[]{"Nhập hàng"}, new String[]{"nhapHang"}));
        dsPanel.add(new PanelChooseQuyen("Sản Phẩm", type, new String[]{"sanPham"}));
        dsPanel.add(new PanelChooseQuyen("Loại Sản Phẩm", type, new String[]{"theLoai"}));
        dsPanel.add(new PanelChooseQuyen("Hóa Đơn", type, new String[]{"hoaDon"}));
        dsPanel.add(new PanelChooseQuyen("Nhân Viên", type, new String[]{"nhanVien"}));
        dsPanel.add(new PanelChooseQuyen("Khách Hàng", type, new String[]{"khachHang"}));
        dsPanel.add(new PanelChooseQuyen("Phiếu Nhập", type, new String[]{"phieuNhap"}));
        dsPanel.add(new PanelChooseQuyen("Nhà Cung Cấp", type, new String[]{"NCC"}));
        dsPanel.add(new PanelChooseQuyen("Tài Khoản", type, new String[]{"taiKhoan"}));
        dsPanel.add(new PanelChooseQuyen("Quyền", type, new String[]{"phanQuyen"}));
