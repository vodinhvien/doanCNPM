...
public class ChonNhanVienForm extends JFrame {
    ...
    public ChonNhanVienForm(JTextField _txMaNV) {
        ...
        // ======= Buttons Panel ===========
        btnCancel.setIcon(new ImageIcon(this.getClass().getResource("/icons/icons8_cancel_30px_1.png")));
        btnOK.setIcon(new ImageIcon(this.getClass().getResource("/icons/icons8_ok_30px.png")));
